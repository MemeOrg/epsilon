...
class MedicationBlock(object):
    ...
    def ResetMedicationPath(self):
        ...
        self.medicalRecords['MedicationPath'][2] = 'stop'
        self.medicalRecords['MedicationPath'][3] = 'stop'
        self.medicalRecords['MedicationPath'][4] = 'stop'
        self.medicalRecords['OnTrabeculectomy'] = False
        
        if self.medicalRecords['MedicationPath'][1] == 'down' :
            self.medicalRecords['MedicationPath'][1] = 'right'
            self.medicalRecords['CurrentMedicationType'] = 6
        else:
            self.medicalRecords['MedicationPath'][1] = 'stop'