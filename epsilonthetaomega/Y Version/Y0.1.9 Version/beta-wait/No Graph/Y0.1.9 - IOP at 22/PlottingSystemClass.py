...
class PlottingSystem(object):
    ...
    def plot(self,SimulationSystem,order,iteration,masterList):
        ...
        print ('Average Conversion time: {}'.format(TotalConversionTime/SimulationSystem.size))
        print ('Average Under 5 conversion: {}'.format(TotalConvUnder5/SimulationSystem.size))
        print ('Average Under 10 conversion: {}'.format(TotalConvUnder10/SimulationSystem.size))
        print (' ')
