...
class PlottingSystem(object):
    ...
    def plot(self,SimulationSystem,order,iteration,masterList):
        ...
        field_names = "QALY,TotalCost,MD,IOPfollow,TE1,TE2,CE,Under5,Under10,nonConversion,withLife,LifeTime".split(",")
        ...
        inner_dict = dict(zip(field_names,[TotalQALY/nuPatientswithLife,
                                           TotalCost/nuPatientswithLife,
                                           TotalMD/nuPatientswithLife,
                                           TotalIOPfollow/nuPatientswithLife,
                                           OccurenceTrabeculectomy/nuPatientswithLife,
                                           Occurence2ndTrabeculectomy/nuPatientswithLife,
                                           OccurenceCataractSurgery/nuPatientswithLife,
                                           TotalConvUnder5/nuPatientswithLife,
                                           TotalConvAbove10/nuPatientswithLife,
                                           TotalnonConv/nuPatientswithLife,
                                           nuPatientswithLife,
                                           totalSystemTime/nuPatientswithLife]))
        ...
        print ('Average 1 trabeculectomy  occurence: {}'.format(float(OccurenceTrabeculectomy/nuPatientswithLife)))
